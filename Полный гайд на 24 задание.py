...
if n15339:
    f = open('24_15339.txt', 'r').read()  # Здесь нам нужна сразу вся последовательность
...
nStatGrad = False
if nStatGrad:
    f = open('22_stat_grad.txt', 'r').read()  # Вставьте свое имя, с которым скачали
    '''
    Как я решал:
...
if n3:
    ...
    f = open('24yaege3.txt', 'r').read()  # Считываем весь файл
...
if n4:
    ...
    '''
    f = open('24yaege4.txt', 'r').read()  # ПЯТЬ(8)
...
if n5:
    ...
    '''
    f = open('24yaege5.txt', 'r').read()  # С добрым утром
